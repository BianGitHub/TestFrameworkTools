#
#  Be sure to run `pod spec lint BLTools.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "边雷"
  # spec.authors            = { "边雷" => "lei.bian2@Pactera-fintech.com" }
  # spec.social_media_url   = "https://twitter.com/边雷"
